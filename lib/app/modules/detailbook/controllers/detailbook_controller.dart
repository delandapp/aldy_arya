...
import 'package:publiclibrary/app/data/models/response_peminjaman.dart';
...
class DetailbookController extends GetxController
    with StateMixin<DataBookDetails> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseDetailsbook.data!.deskripsi!.isEmpty) {
          ...
          change(responseDetailsbook.data, status: RxStatus.success());
